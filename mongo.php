	...
	*/
	...
	private function connect()
	{
		...
		try
		{
			...
			if($_SERVER['HTTP_HOST']=="mentor.smaatapps.io"){
			
				$this->db = $this->connect->selectDB("mentor");
				$this->db = $this->connect->{"mentor"};
			}
			else if($_SERVER['HTTP_HOST']=="ipl.mentorengage.com"){
				
				$this->db = $this->connect->selectDB("mentor_ipl");  
			    $this->db = $this->connect->{"mentor_ipl"}; 
			}
			else{
				
				$this->db = $this->connect->selectDB("mentor_connect");
			    $this->db = $this->connect->{"mentor_connect"}; 
			}
